...
class Pinyin {
    ...
    //全部拼音
    public function getAllPinyin($chinese, $delimiter = '', $first = false,$length = 0) {
        $py = $this->zh_to_pys($chinese, $delimiter,$first);
        if($length > 0) {
    ...
    //拼音首个字母
    public function getFirstPinyin($chinese){
        $result = '' ;
