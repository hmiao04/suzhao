...
<head>
    ...
    <style type="text/css">
        ...
        .copy-right{position: absolute;bottom:0px;padding:5px 0;font-size:12px;right:0;left:0;text-align: center;}
    </style>
</head>
<body>
<div class="error-page">
    <div class="error-page-container">
        ...
        <div class="error-page-main">
            <h3>
                <strong>出错了</strong>您访问的网页可能被吃掉了!
            </h3>
    ...
    <div class="copy-right"><?php YCF::Instance()->getCopyright(); ?></div>
</div>
</body>
</html>